...
public class ISO3166Country
{
    ...
    public static IEnumerable<ISO3166Country> GetIsoCountries()
    {
        return new[] {
                ...
                new ISO3166Country("Bouvet Island", "BV", "BVT", 74, new[] { "999" }),
                ...
                new ISO3166Country("Heard Island and McDonald Islands", "HM", "HMD", 334, new[] { "999" }),
                ...
                new ISO3166Country("San Marino", "SP", "SMR", 674, new[] { "999" }),
                ...
                new ISO3166Country("United States Minor Outlying Islands", "UM", "UMI", 581, new[] { "999" }),
